            ...
            <div className='advertisement-details__container'>
                ...
                <div className='advertisement-details__content'>
                    <div className='advertisement-details__line'>
                        ...
                        <div className='advertisement-details__value'>{this.state.advertisement ? (this.props.type === 'banner' || this.props.type === 'campaign') ? this.state.advertisement.place : this.state.advertisement.search_phrases : '-'}</div>
                    </div>
                    <div className='advertisement-details__line'>
                        ...
                        <div className='advertisement-details__value'>{this.state.advertisement ? this.state.advertisement.count : '-'}</div>
                    </div>
                    <div className='advertisement-details__line'>
                        ...
                        <div className='advertisement-details__value'>{this.state.advertisement ? this.state.advertisement.remaining_count : '-'}</div>
                    </div>
                    <div className='advertisement-details__line'>
                        <div className='advertisement-details__key'>تاریخ شروع</div>
                        <div className='advertisement-details__value'>{this.state.advertisement ? this.state.advertisement.created : '-'}</div>
                    </div>
                </div>
            </div>
        )
